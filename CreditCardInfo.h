...
@property (nonatomic ,copy, readwrite) NSString *cvv2;
...
/// 2-letter code for US states, and the equivalent for other countries. 100 characters max. Required.
 ...
 *  @param cvv2                      Credit Card security code.
